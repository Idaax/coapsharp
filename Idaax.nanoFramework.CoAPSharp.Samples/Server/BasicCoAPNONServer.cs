...
namespace Idaax.nanoFramework.CoAPSharp.Samples.Server
{
    public class BasicCoAPNONServer : ICoAPSample
    {
        ...
        {
            Debug.WriteLine($"{this.GetType().Name} :: Error {e} , associated message {associatedMsg}");
        }
        /// <summary>
        ...
        {
            Debug.WriteLine($"{this.GetType().Name} :: Request received {coapReq}");
        ...
        {
            int temp = DateTime.UtcNow.Second;
